...
int_vif_fit_2 = lm(total_UPDRS ~ .^2 , data = vif_rem_park_trn_data, 
                         subset = non_influential_filter(int_vif_fit))
...
Removing influential points was key in the selection of our model. Using Cook's Distance, and the heuristic discussed in class, an influential point being a point which has Cook's Distance more than 4 times the length of the dataset, as the method, we found about 4% of training data set was influential in different models we fitted. Successively fitting new models using the cleaned data set produced substatianlly better results.
